...
from app.schemas.analysis import RuleResult, RiskForecast, AnalysisResult
    ...
    def generate_heuristic_report(
        ...
        report = {
            ...
            "risk_assessment": {
                ...
                "confidence_level": "High" if len(analysis_result.triggered_rules) > 2 else "Medium"
            },
            "heuristic_analysis": {
                "total_rules_checked": len(analysis_result.triggered_rules) + 5, # Mock total
            ...
            "recommendation": self._derive_recommendation(analysis_result.risk_score, forecast.forecast_30_days)
        }
