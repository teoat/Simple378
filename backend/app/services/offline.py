...
class OfflineStorageService:
    ...
    async def export_case_to_sqlite(self, case_id: str, case_data: Dict[str, Any]) -> str:
        """
        ...
        cursor.execute(
            ...
            (case_data["id"], case_data.get("title"), case_data.get("description"), case_data.get("status"))
        )
    ...
    async def encrypt_archive(self, file_path: str, key: bytes = None) -> tuple[str, bytes]:
        """
