...
async def grant_consent(
    ...
    result = await db.execute(
        select(Subject).where(Subject.id == consent_data.subject_id)
    )
...
async def list_consents(
    ...
    result = await db.execute(select(Consent).where(Consent.subject_id == sub_uuid))
...
async def revoke_consent(
    ...
    result = await db.execute(select(Consent).where(Consent.id == consent_uuid))
...
async def export_subject_data(
    ...
    tx_result = await db.execute(
        select(Transaction).where(Transaction.subject_id == sub_uuid)
    )
