...
async def get_dashboard_metrics(
    ...
    new_high_risk_today = await get_created_after(
        AnalysisResult, yesterday, condition_high_risk
    )
    ...
    new_pending_today = await get_created_after(
        AnalysisResult, yesterday, condition_pending
    )
...
async def get_dashboard_charts(
    ...
    return {"weekly_activity": activity_data, "risk_distribution": risk_distribution}
