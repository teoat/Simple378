...
api_router.include_router(
    mens_rea.router, prefix="/analysis/mens-rea", tags=["mens-rea"]
)
api_router.include_router(
    analysis.router, prefix="/analysis/advanced", tags=["analysis-advanced"]
)
api_router.include_router(
    adjudication.router, prefix="/adjudication", tags=["adjudication"]
)
