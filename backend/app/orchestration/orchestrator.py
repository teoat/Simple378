...
async def document_processor_node(state: InvestigationState):
    ...
    return {
        "messages": [AIMessage(content="DocumentProcessor: Processed uploaded documents.")],
...
async def fraud_analyst_node(state: InvestigationState):
    ...
    return {
        "messages": [AIMessage(content="FraudAnalyst: Analyzed transactions. Found suspicious pattern.")],
